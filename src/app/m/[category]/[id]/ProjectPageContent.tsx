  ...
  useEffect(() => {
    ...
    if (category === 'gourmet' || category.includes('gourmet')) {
      analyzeRestaurant(projectId).then((result) => {
        console.log('[Maat] analyzeRestaurant result:', result ? 'got data' : 'null')
        if (result) {
          setProjectData({
            ...LOADING_PROJECT,
            id: projectId,
          ...
          console.log('[Maat] analyzeRestaurant returned null, showing basic info')
          setProjectData({
            ...LOADING_PROJECT,
            id: projectId,
        ...
        console.error('[Maat] analyzeRestaurant error:', err)
        setProjectData({
          ...LOADING_PROJECT,
          id: projectId,
          name: initialProject?.name || projectId,
