...
> **Reddit for DeFi, where your vote is money.**

把 DeFi 項目的討論變成預測市場 — 你的 upvote 是真金白銀的投注。

---

## 💡 核心概念 (3 句話版)

1. **質押評論** — 發評論要押代幣，減少垃圾內容
2. **投票即投注** — Upvote = 我看好這項目，質押代幣下注
3. **早期發現獎勵** — 最早發現好項目的人，分潤後續交易費
...
| 傳統評論平台 | Kindred |
|-------------|---------|
| 免費發評論 → 垃圾一堆 | 質押發評論 → Skin in the game |
| 點贊沒成本 → 無腦點 | 投票要付錢 → 認真選 |
| 早期貢獻者沒獎勵 | 早期發現者分潤 |
| 信用無法變現 | 高信用 = 低交易費 (Hook) |
...
```
Amazon Reviews + 大眾點評 + DeFiLlama + 信用系統
```
